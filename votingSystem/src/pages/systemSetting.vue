<template>
  <div class="systemSetting layout">
    <nav>
      <el-breadcrumb separator="/">
        <el-breadcrumb-item ><i class="el-icon-setting"></i>管理配置</el-breadcrumb-item>
...
.systemSetting .tool-bar::after{
  content: " ";
  display: block;
  clear: both;
  zoom: 1;
}
.systemSetting .tool-bar .control{
  float: left;
  margin-right: 10px;
}
.systemSetting .tool-bar .input{
  width:240px;
}
.systemSetting .table{
  margin-top: 20px;
}
.systemSetting .table .tabel-header{
  background-color:#eef1f6;
} 
.systemSetting .pagination{
  margin-top:20px;
  text-align: right;
}
.el-dropdown-link{
